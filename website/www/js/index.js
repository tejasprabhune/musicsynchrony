import { getClientID, getClientSecret, getSpotifyTokenKey, getAppleTokenKey } from "./config.js";
...
//	.toString('base64');
const SPOTIFY_TOKEN = getSpotifyTokenKey();

const APPLE_TOKEN = getAppleTokenKey();
/**
